...
class PointDeTrace extends Point
{
    ...
    {
        $tempsCumuleEnSec = $this->tempsCumule;

        $heures = $tempsCumuleEnSec % 3600;
        $tempsCumuleEnSec -= $heures * 3600;

        $minutes = $tempsCumuleEnSec % 60;
        $tempsCumuleEnSec -= $minutes * 60;

        $secondes = $tempsCumuleEnSec;
