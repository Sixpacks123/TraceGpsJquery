...
<div data-role="page" id="page_principale">
    ...
    <div data-role="content">
        ...
        { ?>
            <p>Vous souhaitez retirer à <b><?php echo $pseudoDestinataire; ?></b> l'autorisation de consulter vos parcours.</p>
            ...
            <form action="index.php?action=RetirerAutorisation&pseudoARetirer=<?php echo $pseudoDestinataire; ?>" method="post" data-ajax="false">
